...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHTitulo" runat="server">
    <div style="width: auto; text-align: center; background-color: #d8d8d8;">
        <asp:Label ID="LblTitulo" runat="server" Text="Historico Personal" Font-Size="Large" Font-Bold="True" Font-Italic="True" ForeColor="#0C2261"></asp:Label>
    </div>
</asp:Content>
        ...
        <fieldset style="border-color: black; width: 95%; margin-left: 11px;">
            ...
            <div>
                ...
                <div class="auto-style7">
                    ...
                    <asp:Button ID="BtnNuevBu" runat="server" Text="Nueva Busqueda" Width="163px" CssClass="Boton Marginleft" Font-Size="12pt" OnClick="BtnNuevBu_Click"/>
                </div>
                </div>
            </div>
        </fieldset>
...
<div id="DivHistorico" runat="server" visible="false">
    <fieldset style="border-color: black; width: 95%; margin-left: 11px;">
       <legend style="width: 329px; color: darkblue; font-size: 12px;">Movimientos realizados por personal</legend>
        <div>
            <br />
